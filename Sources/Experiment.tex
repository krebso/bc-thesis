...
We decided to use the pooling layer based on the results from \myref{Appendix}{sec:conv-vs-pool}.
...
Since this method relies on sensitivity, we will only use the $24858$ positive tiles from the test split of the dataset from \myref{Section}{sec:dataset}.
