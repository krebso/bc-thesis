...
Since neural networks can be seen as a complex non-linear attempt to approximate a function we cannot even fully define, it is easy to see that there is little to their transparent nature. If we want to better understand their decisions and reasoning, we need to dive into post-hoc metods.
